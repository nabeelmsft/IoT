...
async def main():
	...
	parser.add_argument("--classNameForTargetObject", type=str, default="", help="class name of the object that is required to be detected. Once detected message would be sent to Azure IoT Hub")
	...
	while display.IsOpen():
		...
		if class_desc == opt.classNameForTargetObject:
